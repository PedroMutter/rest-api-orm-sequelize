...
class PessoaController {
  static async pegaPessoasAtivas(req, res) {
    try {
      const pessoasAtivas = await pessoasServices
        .pegaRegistrosAtivos()
  ...
  static async pegaPessoa(req, res) {
    const { id } = req.params
    try {
      const pessoa = await pessoasServices
        .pegaUmRegistro({ id })
  ...
  static async atualizaPessoa(req, res) {
    ...
    try {
      await pessoasServices
        .atualizaRegistro(novasInfos, Number(id))
